...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        spent_calories = ((coef_calories_1 * self.get_mean_speed()
                          - coef_calories_2) * self.weight
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    workout_codes_dict = {'SWM': Swimming,
                          'RUN': Running,
                          'WLK': SportsWalking}
    if workout_type in workout_codes_dict:
        workout = workout_codes_dict[workout_type](*data)
        return workout
    else:
